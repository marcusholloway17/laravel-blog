                ...
                <section style="margin-top: 2rem">
                    <form action="{{ route('categories.update', $category) }}" method="POST" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="label" name="label" type="text" class="mt-1 block w-full" :value="old('name', $category->label)"
                        ...
                        <div>
                            ...
                            <x-text-input id="description" name="description" type="text" class="mt-1 block w-full" :value="old('name', $category->description)"
